...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/icon-app-english-me.svg
  SvgGenImage get iconAppEnglishMe =>
      const SvgGenImage('assets/images/icon-app-english-me.svg');

  /// File path: assets/images/wellcome.png
  AssetGenImage get wellcome =>
      const AssetGenImage('assets/images/wellcome.png');

  /// List of all assets
  List<dynamic> get values => [iconAppEnglishMe, wellcome];
}
